...
type PublishReply struct {
	...
	// The list of event rejections.
	// An event might not pass the validation,
	// e.g. does not have a required field or has invalid metadata or fields
	Rejected []*Rejection `protobuf:"bytes,5,rep,name=rejected,proto3" json:"rejected,omitempty"`
}
...
func (x *PublishReply) GetRejected() []*Rejection {
	if x != nil {
		return x.Rejected
	}
	return nil
...
// Rejection is a status object that describes why a certain
// event from the batch was rejected by the server.
type Rejection struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// Index of the rejected event in the list of events from the initial `PublishRequest`
	EventsIndex uint64 `protobuf:"varint,1,opt,name=events_index,json=eventsIndex,proto3" json:"events_index,omitempty"`
	// Status field that explains the reason of the rejection
...
func (x *Rejection) GetEventsIndex() uint64 {
	if x != nil {
		return x.EventsIndex
	}
	return 0
}

func (x *Rejection) GetReason() *status.Status {
	if x != nil {
		return x.Reason
	}
	return nil
...
var file_messages_publish_proto_rawDesc = []byte{
	...
	,
	...
	,
	...
	0x65, 0x22, 0xe3, 0x01, 0x0a, 0x0c, 0x50, 0x75, 0x62, 0x6c, 0x69, 0x73, 0x68, 0x52, 0x65, 0x70,
	...
	,
...
var file_messages_publish_proto_goTypes = []interface{}{
	...
	(*Rejection)(nil),             // 5: elastic.agent.shipper.v1.messages.Rejection
...
var file_messages_publish_proto_depIdxs = []int32{
	...
	5, // 6: elastic.agent.shipper.v1.messages.PublishReply.rejected:type_name -> elastic.agent.shipper.v1.messages.Rejection
	8, // 7: elastic.agent.shipper.v1.messages.Rejection.reason:type_name -> google.rpc.Status
